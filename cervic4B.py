...
#opt = SGD(lr=0.01)
opt = Adam(lr=1e-3)
#opt = SGD(lr=config.MIN_LR)
#opt = keras.optimizers.Adam(lr=1e-3, beta_1=0.3, beta_2=0.999, epsilon=1e-08)
...
if rate!=1:
	...
	lrf.find(
		train_datagen.flow(testX, testY, batch_size=config.BATCH_SIZE),
		5e-12, 5e+1,epochs=8,
